<x-admin>
    <div class="flex flex-col gap-6 max-w-4xl mx-auto">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-bold text-white">Editar Mascota</h1>
        ...
        <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-8 shadow-lg">
            <form action="{{ route('admin.mascotas.update', $mascota->id) }}" method="POST" class="flex flex-col gap-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="cliente_id" required class="w-full bg-gray-900 border border-gray-600 rounded-lg p-3 text-white focus:border-neon-blue focus:ring-1 focus:ring-neon-blue outline-none transition">
                            ...
                            @foreach($clientes as $cliente)
                                <option value="{{ $cliente->id }}" {{ old('cliente_id', $mascota->cliente_id) == $cliente->id ? 'selected' : '' }}>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="codigo_mascota" value="{{ old('codigo_mascota', $mascota->codigo_mascota) }}" required
