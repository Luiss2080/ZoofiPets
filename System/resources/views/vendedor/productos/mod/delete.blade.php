<div id="deleteModal" class="modal-overlay"> <!-- Reference ID shared logic -->
    <div class="modal-container"> 
        ...
        <div class="modal-body">
            <p>Se eliminará el producto <span id="deleteItemName" style="color: #fff; font-weight: 700;"></span>.</p>
            <p class="text-sm">Esto puede afectar registros de inventario históricos.</p>
        </div>
        ...
        <div class="modal-actions">
            ...
            <form id="deleteForm" action="" method="POST" style="display: inline; flex: 1;">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn-modal btn-modal-confirm" id="confirmDeleteBtn">Eliminar Producto</button>
            </form>
        </div>
    </div>
</div>
