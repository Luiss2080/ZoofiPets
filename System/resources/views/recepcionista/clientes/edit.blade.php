<x-admin>
    <div class="flex flex-col gap-6 max-w-4xl mx-auto">
        ...
        <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-8 shadow-lg">
            <form action="{{ route('admin.clientes.update', $cliente->id) }}" method="POST" class="flex flex-col gap-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="cedula" value="{{ old('cedula', $cliente->cedula) }}" required
