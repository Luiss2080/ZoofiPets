<div id="errorModal" class="modal-overlay">
    <div class="modal-content error">
        ...
        <div class="modal-header">
            ...
            <h3 style="color: #e11d48; text-shadow: 0 0 15px rgba(225, 29, 72, 0.4);">¡Error en Pago!</h3>
        </div>
        ...
        <div class="modal-body">
            <div class="target-card">
                ...
                <div class="target-details">
                    ...
                    <h4 id="errorMessage" style="font-family: 'Montserrat', sans-serif;">Ha ocurrido un error al procesar</h4>
                </div>
            </div>
        </div>
