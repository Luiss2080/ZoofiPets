<div id="deleteModal" class="modal-overlay"> <!-- Reference ID shared logic -->
    <div class="modal-container"> 
        ...
        <div class="modal-body">
            <p>Se eliminará el registro del movimiento <span id="deleteItemName" style="color: #fff; font-weight: 700;"></span>.</p>
            <p class="text-sm">Esta acción es irreversible y podría afectar la trazabilidad.</p>
        </div>
