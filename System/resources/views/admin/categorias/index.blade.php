...
@push('styles')
    {{-- LINKING SPECIFIC CSS FROM CATEGORIAS FOLDER AS REQUESTED --}}
    <link rel="stylesheet" href="{{ asset('css/admin/categorias/index.css') }}">
...
<div class="consultas-container">
    ...
    <div class="control-panel">
        <div class="panel-header">
            <div class="header-title">
                ...
                <div class="title-content">
                    ...
                    <p class="subtitle">Organización y segmentación del inventario de la tienda</p>
                </div>
            </div>
        ...
        <div class="panel-content">
            <div class="search-bar">
                ...
                <input type="text" id="searchInput" placeholder="Buscar categoría..." value="{{ request('search') }}">
            </div>
                        ...
                        <tr>
                            <td>
                                <div class="user-info">
                                    ...
                                    <div class="details">
                                        <span class="name" style="font-weight: 700; color: var(--text-primary);">{{ $categoria->nombre }}</span>
                                        <span class="role">ID: {{ $categoria->id }}</span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="sub-text">{{ $categoria->descripcion ?? 'Sin descripción' }}</span>
                            </td>
                            <td>
                                <span class="badge" style="background: rgba(59, 130, 246, 0.1); color: #3b82f6; border: 1px solid rgba(59, 130, 246, 0.2);">
                                    <i class="fas fa-boxes"></i> {{ $categoria->productos_count }}
                                </span>
                            </td>
                            <td>
                                @if($categoria->activo)
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    {{-- 3. Audit/Log (Purple) --}}
                                     <a href="#" class="btn-icon audit" title="Historial">
                                    ...
                                    <button type="button" 
                                            ...
                                            onclick="openDeleteModal('#', '{{ $categoria->nombre }}')">
    ...
    <div class="pagination-wrapper">
        {{ $categorias->appends(request()->query())->links('pages.categorias') }}
    </div>
</div>

@include('admin.categorias.mod.delete')
@include('admin.categorias.mod.error')
@endsection
