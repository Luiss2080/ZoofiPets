<div id="deleteModal" class="modal-overlay"> <!-- Reference ID shared logic -->
    <div class="modal-container"> 
        ...
        <div class="modal-body">
            <p>Se eliminará el método de pago <span id="deleteItemName" style="color: #fff; font-weight: 700;"></span>.</p>
            <p class="text-sm">Esta acción puede afectar al historial de transacciones.</p>
        </div>
        ...
        <div class="modal-actions">
            ...
            <form id="deleteForm" action="" method="POST" style="display: inline; flex: 1;">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn-modal btn-modal-confirm" id="confirmDeleteBtn">Eliminar Método</button>
            </form>
        </div>
    </div>
</div>
