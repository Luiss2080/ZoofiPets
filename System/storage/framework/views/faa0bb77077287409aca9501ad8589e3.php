...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/LogoPestaña.jpg')); ?>">
                ...
                <div class="branding-content">
                    ...
                    <div class="brand-section">
                        <div class="logo-container">
                            ...
                            <img src="<?php echo e(asset('images/LogoLogin.png')); ?>" alt="ZOOFIPETS" class="brand-logo">
                        </div>
                ...
                <div class="form-container"> <!-- Header del formulario -->
                    ...
                    <div class="form-footer">
                        <p class="register-text">
                            ...
                            <span class="highlight"><a href="<?php echo e(route('registro')); ?>" class="register-link" id="registerLink">¡Solicita tu registro!</a></span>
                        </p>
