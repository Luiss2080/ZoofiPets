...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/faviconTH.png')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/layouts/loading.css')); ?>">
...
<body>
    <!-- Loading Screen -->
    <?php echo $__env->make('layouts.loading', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="branding-content">
                    ...
                    <div class="brand-section">
                        <div class="logo-container">
                            ...
                            <img src="<?php echo e(asset('images/LogoTech.png')); ?>" alt="TECH HOME" class="brand-logo">
                        </div>
            ...
            <div class="login-form-section">
                ...
                <div class="form-container"> <!-- Header del formulario -->
                    ...
                    <div class="alert alert-error">
                        ...
                        <div class="alert-message"><?php echo e($errors->first()); ?></div>
                    </div>
                    <?php endif; ?>
                    ...
                    <!-- Formulario de login -->
                    <form class="login-form" method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-options">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="forgot-password" id="forgotPasswordLink">¿Olvidaste tu contraseña?</a>
                        </div>
                    ...
                    <div class="form-footer">
                        <p class="register-text">
                            ...
                            <span class="highlight"><a href="<?php echo e(route('register.show')); ?>" class="register-link" id="registerLink">¡Solicita tu registro!</a></span>
                        </p>
    ...
    <script src="<?php echo e(asset('js/layouts/loading.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\ZoofiPets\System\resources\views/auth/login.blade.php ENDPATH**/ ?>