document.addEventListener("DOMContentLoaded", function () {
    ...
    const form = document.querySelector("form"); // General select for edit form
    if (form) {
    ...
    const initCustomSelects = () => {
        ...
        customSelects.forEach((select) => {
            ...
            Array.from(select.options).forEach((option) => {
                if (option.disabled && option.value === "") return; // Skip placeholder if empty/disabled
                ...
                if (option.selected) {
                    ...
                    // Ensure trigger text is correct for initial load of edit view
